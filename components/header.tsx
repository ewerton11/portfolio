    ...
    <header className="w-full h-20 sticky top-0 z-50 flex">
      <div className="relative w-full h-full">
        <div className="absolute left-[10%] h-full flex justify-center items-center">
          <h1 className="text-5xl text-text-offWhite font-robotoMono font-bold">
            <Link href="#start">er.</Link>
          </h1>
        </div>
        <div className="absolute right-[10%] flex w-auto h-full items-center">
          <nav className="w-11/12">
            <ul className="h-full flex items-cente font-roboto text-xl">
              <li className="p-5 hover:text-mode-dark">
          ...
          <div className="w-10 h-full flex justify-center items-center ml-1 cursor-pointer">
            <DarkThemeIcon />
          </div>
        </div>
      </div>
