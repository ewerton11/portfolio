        ...
        <div className="w-[90%] md:w-[88%] h-full flex flex-col justify-center relative">
          <div className="w-full h-full flex flex-col lg:justify-center text-sm lg:text-xl font-roboto">
            ...
            <div className="w-full h-auto flex items-center mt-7 lg:mt-0">
              <p className="flex-1">
                Me chamo Ewerton e sou desenvolvedor fullstack. Atualmente,
                tenho 22 anos e moro no Rio de Janeiro, Brasil. Sempre fui
                apaixonado por tecnologias e sou curioso. Foi assim que conheci
                ...
                sigo nesse modelo, trabalhando como freelancer, ajudando pessoas
                e me desenvolvendo cada vez mais.
              </p>
